...
export default function Footer() {
  ...
  const socialLinks = [
    {
      name: "YouTube",
      href: "https://www.youtube.com/@Saurav_Speaks",
      icon: Youtube,
    },
    {
      name: "Instagram",
      href: "https://www.instagram.com/saurav__speaks",
      icon: Instagram,
    },
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/in/saurav-speaks",
      icon: Linkedin,
    },
    {
      name: "Twitter",
    ...
    {
      name: "Email",
      href: "mailto:sauravsarker150@gmail.com",
      icon: Mail,
    },
  ];
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="border-t border-white/5 mt-16 pt-8 text-center">
          <p className="text-gray-500 text-sm flex items-center justify-center gap-1.5">
            ...
            <a
              href="https://www.linkedin.com/in/ariyanshihabeditz"
              target="_blank"
              rel="noopener noreferrer"
